...
import { ChevronLeft, ChevronRight, Settings, X, PanelLeftClose, PanelRightClose } from "lucide-react";
...
function Sidebar({
 ...
 const tabStyle = (active) =>
   `px-4 py-2 font-semibold border-b-2 ${active ? "border-sky-600 text-white" : "border-transparent text-gray-400 hover:text-white hover:border-gray-600"} cursor-pointer select-none transition-colors`;
   ...
   <div className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 to-black text-gray-100 font-sans">
                   ...
                   return (
                     <div
                       ...
                       onClick={() => {
                         ...
                         setSidebarInitialTab("tasks"); // Set sidebar to open on 'Tasks' tab
                         setSidebarOpen(true);
                       }}
     ...
     <Sidebar
       ...
       onClose={() => {
         ...
         setSelectedTask(null);
         setSidebarInitialTab("upcoming"); // Reset to default when closed
       }}
