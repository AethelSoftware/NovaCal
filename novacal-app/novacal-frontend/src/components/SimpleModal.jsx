      ...
      >
        ...
        <div className="p-6 flex-1 space-y-5">
          <label className="block">
            <span className="block text-sm text-stone-300 mb-1">Task Name</span>
            <input
              type="text"
              required
              maxLength={100}
          ...
          <label className="block">
            <span className="block text-sm text-stone-300 mb-1">Description</span>
            <textarea
              value={description}
          ...
          <label className="block">
            <span className="block text-sm text-stone-300 mb-1">Links (comma separated URLs)</span>
            <input
              type="text"
              value={links}
